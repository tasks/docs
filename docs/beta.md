...
New releases for Tasks.org are available to beta testers before they are released publicly
...
* If you have multiple Google accounts make sure you opt-in with the same Google account that you used to download Tasks.org
